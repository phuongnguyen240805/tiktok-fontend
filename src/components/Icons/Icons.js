...
export const ListIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const EmptyVideoIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
